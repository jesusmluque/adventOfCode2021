...
object ExtendedPolymerization {
  ...
  def getDifferenceMostAndLessOccurrences(template: String, pairInsertionRawRules: List[String], steps: Int) =
  ...
  def getDifferenceMostAndLessOccurrences2(template: String, pairInsertionRawRules: List[String], steps: Int) =
    ...
    val totalPairs = (1 to steps).foldLeft((templatePairs._2, templatePairs._3)) { (acc, step) =>
      acc._1.foldLeft((Map[(String, String), Long](), acc._2)) { (acc2, oldPair) =>
        ...
        (acc2._1.updated((oldPair._1._1, elementToInsert), acc2._1.getOrElse((oldPair._1._1, elementToInsert), 0L) + oldPair._2)
          .updated((elementToInsert, oldPair._1._2), acc2._1.getOrElse((elementToInsert, oldPair._1._2), 0L) + oldPair._2), acc2._2.updated(elementToInsert, acc2._2.getOrElse(elementToInsert, 0L) + oldPair._2))
      }
    }
